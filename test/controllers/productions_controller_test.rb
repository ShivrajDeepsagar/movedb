...
class ProductionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create production" do
    assert_difference('Production.count') do
      post productions_url, params: { production: { director: @production.director, name: @production.name, status: @production.status } }
    end
  ...
  test "should update production" do
    patch production_url(@production), params: { production: { director: @production.director, name: @production.name, status: @production.status } }
